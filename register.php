...
<div class="wrapper">
    ...
    <div id="first">
     <form action="register.php" method="POST">
		...
		<br>
		<a href="#" id="signup" class="signup">Need and accounr? Register here!</a>
   ...
   <div id="second">
   	<form action="register.php" method="POST">
		...
		<label>Birth Date : </label>
            <input type="date" name="date_nais" value="<?php 
		if(isset($_SESSION['date_nais'])) {
			echo $_SESSION['date_nais'];
		} 
		?>"  required /><br />

            <label>Gender :</label>
        <select name="Gender" value="<?php 
